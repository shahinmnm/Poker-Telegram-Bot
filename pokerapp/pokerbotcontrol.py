...
class PokerBotCotroller:
    def __init__(self, model: PokerBotModel, updater: Updater):
        ...
        # این کنترلر برای دکمه "نمایش میز" اضافه شد
        updater.dispatcher.add_handler(
            MessageHandler(Filters.regex('^👁️ نمایش میز$'), self._handle_show_table)
        )
    ...
    def _handle_show_table(self, update: Update, context: CallbackContext) -> None:
        """این متد برای رسیدگی به کلیک روی دکمه 'نمایش میز' است"""
